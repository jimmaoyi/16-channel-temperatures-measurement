...
#define TMR_COUNT   12                           /* 软件定时器个数，第一个保留给DelayMs()使用*/
#define segFlashTime 40                         //
#define displayInterval 3000                    //6s
...
uint8   LineNumber1 = 0;
uint8   RecIP[4] = { 0 };
uint8   begainDisplayMoney_flag = 1;
